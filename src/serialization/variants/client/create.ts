...
export const Request: core.schemas.Schema<serializers.variants.create.Request.Raw, FliptApi.VariantCreateRequest> =
  core.schemas.object({
...
export const Response: core.schemas.Schema<serializers.variants.create.Response.Raw, FliptApi.Variant> =
